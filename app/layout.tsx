...
@media (max-width: 768px) {
  ...
  .testimonial-grid-4 > div { flex-direction: column !important; }
  .testimonial-grid-4 > div > div:first-child { width: 100% !important; height: 160px !important; position: relative !important; }
